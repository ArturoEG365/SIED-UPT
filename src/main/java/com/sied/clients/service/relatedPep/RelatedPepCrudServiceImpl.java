...
public class RelatedPepCrudServiceImpl implements RelatedPepCrudService {
    ...
    @Override
    public CompletableFuture<RelatedPepCrudResponseDto> create(RelatedPepCrudRequestDto request) {
    ...
    @Override
    public CompletableFuture<PaginatedResponse<RelatedPepCrudResponseDto>> getAll(int offset, int limit) {
        return CompletableFuture.supplyAsync(() -> {
            try {
    ...
    @Override
    public CompletableFuture<RelatedPepCrudResponseDto> get(Long id) {
        return CompletableFuture.supplyAsync(() -> {
            try {
    ...
    @Override
    public CompletableFuture<RelatedPepCrudResponseDto> update(RelatedPepCrudUpdateRequestDto request) {
        return CompletableFuture.supplyAsync(() -> {
            try {
